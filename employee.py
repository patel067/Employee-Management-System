...
class Employee :
    def __init__(self,root) :
        ...
        # 2nd image
        img2 = Image.open('images/img3.jpg')
        ...
        # 3rd image
        img3 = Image.open('images/img2.jpg')
        ...
        #Add Employee Image
        employeeImg= Image.open('images/img4.jpg')
        ...
        btn_save = Button(button_frame,text="Save",command=self.AddData,font=('arial',12,'bold'),fg='white',bg='yellow',width=12)
        btn_save.grid(row=0,column=0,pady=7,sticky=W)

        btn_update = Button(button_frame,command=self.updateData,text="Update",font=('arial',12,'bold'),fg='white',bg='red',width=12)
        ...
        btn_reset = Button(button_frame,text="Reset",command=self.resetEmployeeInfo,font=('arial',12,'bold'),fg='white',bg='pink',width=12)
    ...
    def AddData(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="root",password="root",database="employeeschema")
        cursor = conn.cursor()
        try:
    ...
    def deleteData(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="root",database="employeeschema")
        cursor= conn.cursor()
